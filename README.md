...
<h3 align="center"> 
[Clique aqui para ver como está o andamento do projeto!](https://alurakut-robson525.vercel.app/) 
</h3>

## 📚 Desafios
  - Aula 01
    - [x] Pegar os dados da API do GitHub e listar seus seguidores;
    - [x] Adicionar quão confiável, legal e sexy você é (Numeros aleatórios ao carregar a página);
